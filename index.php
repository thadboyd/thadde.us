...
<div id="tabs">
  <nav><ul>
    <li class="tab tab-websites"><a href="#websites">
      <span class="fa fa-globe"></span><br/>
      Websites
    </a></li>
    <li class="tab tab-audiobooks"><a href="#audiobooks">
      <span class="fa fa-book"></span><br/>
      Audiobooks
    </a></li>
  </ul></nav>
  
  <section id="websites" class="tab-content tab-websites">
    <h2>Websites</h2>
  ...
  <section id="audiobooks" class="tab-content tab-audiobooks">
    <h2>Audiobooks</h2>
